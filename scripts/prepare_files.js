...
const sourcePath = path.resolve('output/'); // assume we're in gameDir/devTools/apkbuilder
const sourceDirs = ["img"]; // it's almost universally just img
const sourceName = "Degrees of Lewdity VERSION.html.mod.html"; // game's compiled html
